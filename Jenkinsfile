...
// variables:
//      https://github.com/ganesh306/events-app-api-server.git
//      main
//      roidtc-m2022-u305
//      demo-api
//      cnd-events-cluster 
    ...
    stages {
        stage('Get Source') {
            ...
            steps {
                ...
                git branch: 'main',
                    url: 'https://github.com/ganesh306/events-app-api-server.git'
        ...
        stage('Run Tests') {
         ...
         stage('Build and deploy the container') {
            ...
            steps {
                echo "submit gcr.io/roidtc-m2022-u305/demo-api:v2.${env.BUILD_ID}"
                sh "gcloud builds submit -t gcr.io/roidtc-m2022-u305/demo-api:v2.${env.BUILD_ID} ."
                echo 'Get cluster credentials'
                sh 'gcloud container clusters get-credentials cnd-events-cluster --zone us-central1-c --project roidtc-m2022-u305'
                echo "Update the image to use gcr.io/roidtc-m2022-u305/demo-api:v2.${env.BUILD_ID}"
                sh "kubectl set image deployment/demo-api demo-api=gcr.io/roidtc-m2022-u305/demo-api:v2.${env.BUILD_ID}"
            }
        }            
    }
}
